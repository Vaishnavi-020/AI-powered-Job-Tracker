...
def view_single_application_service(application_id:int,db:Session,current_user:User):
    existing_application=db.query(Application).filter(Application.id==application_id).first()
